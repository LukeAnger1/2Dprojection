...
/* Include files */
#include "_coder_libstatic_c_api.h"
#include "_coder_libstatic_c_mex.h"
...
void libstatic_c_atexit(void)
{
  ...
  libstatic_c_xil_terminate();
  libstatic_c_xil_shutdown();
  emlrtExitTimeCleanup(&emlrtContextGlobal);
}
...
/* End of code generation (_coder_libstatic_c_api.c) */
