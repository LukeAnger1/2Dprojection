 ...
 *
 * _coder_libstatic_c_api.h
 *
 * Code generation for function 'initialize_main'
 *
 */

#ifndef _CODER_LIBSTATIC_C_API_H
#define _CODER_LIBSTATIC_C_API_H
...
void libstatic_c_xil_shutdown(void);

void libstatic_c_xil_terminate(void);
...
#endif
/* End of code generation (_coder_libstatic_c_api.h) */
