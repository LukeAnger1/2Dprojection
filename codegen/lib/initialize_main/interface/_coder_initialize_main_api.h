 ...
 *
 * _coder_initialize_main_api.h
 *
 * Code generation for function 'initialize_main'
 *
 */

#ifndef _CODER_INITIALIZE_MAIN_API_H
#define _CODER_INITIALIZE_MAIN_API_H
...
void initialize_main_xil_shutdown(void);

void initialize_main_xil_terminate(void);
...
#endif
/* End of code generation (_coder_initialize_main_api.h) */
