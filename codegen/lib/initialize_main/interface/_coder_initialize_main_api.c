...
void initialize_main_atexit(void)
{
  emlrtStack st = {
      NULL, /* site */
      NULL, /* tls */
  ...
  initialize_main_xil_terminate();
  initialize_main_xil_shutdown();
  emlrtExitTimeCleanup(&emlrtContextGlobal);
}
...
/* End of code generation (_coder_initialize_main_api.c) */
