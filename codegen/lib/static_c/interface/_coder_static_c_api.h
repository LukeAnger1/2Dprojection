 ...
 *
 * _coder_static_c_api.h
 *
 * Code generation for function 'initialize_main'
 *
 */

#ifndef _CODER_STATIC_C_API_H
#define _CODER_STATIC_C_API_H
...
void static_c_atexit(void);

void static_c_initialize(void);

void static_c_terminate(void);

void static_c_xil_shutdown(void);

void static_c_xil_terminate(void);
...
#endif
/* End of code generation (_coder_static_c_api.h) */
